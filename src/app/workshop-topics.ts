...
export const WORKSHOP_TOPICS: readonly WorkshopTopic[] = [
  {
    ...
    readmePath: '/themes/exercise-1/README_theme.md'
  },
  {
    order: 2,
    ...
    readmePath: '/themes/exercise-2/README_theme.md'
  },
  {
    order: 3,
    id: 'signals',
    ...
    readmePath: '/themes/exercise-3/README_theme.md'
  },
  {
    order: 4,
    ...
    readmePath: '/themes/exercise-4/README_theme.md'
  },
  {
    order: 5,
    ...
    readmePath: '/themes/exercise-5/README_theme.md'
  },
  {
    order: 6,
    ...
    readmePath: '/themes/exercise-6/README_theme.md'
  },
  {
    order: 7,
    id: 'defer',
    ...
    readmePath: '/themes/exercise-7/README_theme.md'
  }
] as const;
