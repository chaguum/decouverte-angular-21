...
import { Exercise5SandboxProductsService } from './exercise-5-sandbox-products.service';

@Component({
  selector: 'app-exercise-5-sandbox',
  templateUrl: './exercise-5-sandbox.html',
  styleUrl: './exercise-5-sandbox.css',
  providers: [Exercise5SandboxProductsService],
...
export class Exercise5Sandbox implements OnInit {
  ...
  protected readonly service = inject(Exercise5SandboxProductsService);
