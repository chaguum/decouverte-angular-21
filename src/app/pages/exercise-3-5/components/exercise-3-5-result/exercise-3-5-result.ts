...
import { Exercise35ResultSummary } from '../exercise-3-5-result-summary/exercise-3-5-result-summary';
...
@Component({
  selector: 'app-exercise-3-5-result',
  imports: [FormsModule, Exercise35ResultSummary],
  templateUrl: './exercise-3-5-result.html',
  styleUrl: './exercise-3-5-result.css',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class Exercise35Result {
